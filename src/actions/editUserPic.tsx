...
export const editProfilePicError = (error: { code: string, message: string, a: null }) => {
    return {
...
export function* sagaEditProfilePicWorker(action: {payload: {url: string, usercounter: number}, type: string}) {
