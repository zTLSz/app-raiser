...
export const subscribeUserError = (code: string | number) => {
  return {
...
export function* sagaSubscribeUser(action: {
  payload: SubscribeUserTypes;
  type: string;
