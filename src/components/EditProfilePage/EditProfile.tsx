        ...
        <Content>
          <Row>
            ...
            >
              <EditItem>
                <label>
                  <LabelText>Введите немного информации о себе</LabelText>
                  <Input
              ...
              <EditItem>
                <Button
                  ...
                  size="large"
                  onClick={() =>
                    dispatch(requestEditProfile(name, usercounter))
                  }
                  disabled={false}
                >
                  Сохранить
              ...
              <EditStatus>
                {editstatus.isEdit ? (
                  <Text type="success">Успешное изменение профиля!</Text>
                ) : (
                  ""
                )}
                {editstatus.isEditError ? (
                  <Text type="danger">
            ...
            <EditUserPic usercounter={usercounter} userinfo={userinfo} />
          </Row>
        </Content>
      </Layout>
    </div>
